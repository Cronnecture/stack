...
PLAYBOOKS = [
    ...
    {"tag": "identity", "name": "Identity keep-set", "description": "Authentik, Passbolt, Cerbos (Logto and Hanko retired)", "hosts": "compute_general"},
...
API_SURFACES = [
    ...
    {"name": "control-plane-legacy", "kind": "python", "pin": "cp-master-01", "notes": "Portal snapshot, Authentik OIDC, billing GET, delete-client"},
